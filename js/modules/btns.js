...
layui.define(function(exports) {
    ...
    var btnConfig = {
        ...
        'row-payment-change': {
            className: baseBtnClass + 'layui-btn-small layui-btn-danger row-payment-change',
            icon: '&#xe63c;',
            name: '款项变更'
        },
		'row-continue': {
			className: baseBtnClass + 'layui-btn-small layui-btn-danger row-continue',
            icon: '&#xe64c;',
            name: '续签'
		},
        'row-view-class': {
			className: baseBtnClass + 'layui-btn-small layui-btn-normal row-view-class',
            icon: '&#xe615;',
            name: '查看班级'
		},
        'row-config-class': {
			className: baseBtnClass + 'layui-btn-small layui-btn-normal row-config-class',
            icon: '&#xe631;',
            name: '配置班级'
		},
        'row-view-account': {
			className: baseBtnClass + 'layui-btn-small layui-btn-normal row-view-account',
            icon: '&#xe615;',
            name: '查看帐号'
		},
        'row-append-account': {
			className: baseBtnClass + 'layui-btn-small layui-btn-normal row-append-account',
            icon: '&#xe608;',
            name: '追加帐号'
		},
        'row-stop': {
        ...
        'row-append-report': {
			className: baseBtnClass + 'layui-btn-small layui-btn-normal row-append-report',
            icon: '&#xe608;',
            name: '追加订单'
		},
